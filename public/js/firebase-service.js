...
window.FIB.sendGroupChatMessage = async function(channelId, messageText, extraData = {}){
  ...
  await ref.set({
    ...
    mentionedOrderId: extraData.mentionedOrderId || extraData.orderMention?.orderId || "",
    mentionedOrderNumber: extraData.mentionedOrderNumber || extraData.orderMention?.orderId || "",
    orderMention: extraData.orderMention || null,
    reactions: [],
    isEdited: false,
    editedAt: null,
    createdAt: firebase.firestore.FieldValue.serverTimestamp(),
